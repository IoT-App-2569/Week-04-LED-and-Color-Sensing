...
- **จากกราฟที่พล็อตออกมา นักศึกษาสังเกตเห็นแนวโน้มตัวเลขของค่า ADC ตั้งแต่แซมเปิ้ลที่ 1 ไต่ระดับลงมาหรือขึ้นไปจนถึงแซมเปิ้ลที่ 20 อย่างไร?**

**แนวโน้มค่า ADC จากแซมเปิ้ล 1 → 20**
จากการวิเคราะห์กราฟพบว่า ค่า ADC มีแนวโน้ม **ลดลงอย่างชัดเจน (Decay)** จากค่าสูงลงมาต่ำ โดยมีลักษณะคล้ายคลึงกับกราฟแบบ Exponential Decay ซึ่งในช่วงแรกค่าจะตกลงอย่างรวดเร็ว (ช่วงแซมเปิ้ลที่ 1-6 ค่าลดลงไปมากกว่า 80% จากค่าเริ่มต้น) หลังจากนั้นความชันจะค่อย ๆ ลดลงจนกราฟเริ่มอยู่ในแนวราบ ปรากฏการณ์นี้เกิดจากการที่รอยต่อ PN ของตัว LED (ในฐานะภาครับแสง) ยังคงมีประจุไฟฟ้าสะสมอยู่เมื่อไฟพึ่งดับลง และประจุเหล่านี้จะค่อย ๆ คายออกจนแรงดันตกลงใกล้ระดับ 0

**ตารางเปรียบเทียบอัตราการลดลงของค่า ADC (แซมเปิ้ล 1 ถึง 20)**

| สีของ LED | ค่า ADC (แซมเปิ้ล 1) | ค่า ADC (แซมเปิ้ล 20) | อัตราการลดลงโดยประมาณ |
| :--- | :---: | :---: | :---: |
| **สีแดง** | 1309 | 46 | ~28 เท่า |
| **สีเขียว** | 1396 | 69 | ~20 เท่า |
| **สีน้ำเงิน** | 1383 | 45 | ~31 เท่า |

<br>

- **สัญญาณไฟฟ้าเข้าสู่ความนิ่ง (Settling) ที่แซมเปิ้ลใด หรือใช้เวลากี่มิลลิวินาที?**

เมื่อสัญญาณเริ่มนิ่ง ค่าจะแกว่งตัวอยู่ในกรอบแคบ ๆ ดังนี้:
* **LED แดง:** แกว่งตัวอยู่ในช่วงค่า 46 - 105
* **LED เขียว:** แกว่งตัวอยู่ในช่วงค่า 69 - 130
* **LED น้ำเงิน:** แกว่งตัวอยู่ในช่วงค่า 45 - 136

การที่กราฟยังคงมีการ "กระเพื่อมเล็กน้อย" และไม่ราบเรียบสนิท 100% แม้จะนิ่งแล้ว เป็นผลมาจากสัญญาณรบกวนรอบข้าง (Ambient Noise) ที่เอกสารพูดถึง เช่น สัญญาณไฟกระพริบความถี่ 50Hz จากหลอดไฟฟลูออเรสเซนต์ภายในห้อง
...
ความชันของกราฟที่ดิ่งลงอย่างรวดเร็วในช่วงแซมเปิ้ล 1-6 (ค่าลดจาก ~1300 เหลือ ~200 ในระยะเวลาเพียง 900 ms) เป็นการสะท้อนให้เห็นถึงข้อจำกัดทางฟิสิกส์ของฮาร์ดแวร์ (ไม่ใช่บั๊กของซอฟต์แวร์) กล่าวคือ ในโหมด Photovoltaic ตัว LED ภาครับจะมีความต้านทานสูงมาก (High Impedance) และสามารถสร้างกระแสไฟฟ้าได้เพียงระดับนาโนแอมแปร์ (nA) 

เมื่อคุณสมบัตินี้ทำงานร่วมกับค่าความจุไฟฟ้าแฝงของวงจร Sample-and-Hold ภายในตัว ADC ของไมโครคอนโทรลเลอร์ จึงทำให้เกิด **ค่าคงตัวของเวลา (RC Time Constant)** ส่งผลให้ประจุไฟฟ้าต้องใช้เวลาในการค่อย ๆ คายออก ไม่สามารถดึงค่าแรงดันให้ตกเป็นศูนย์ได้ทันทีที่ปิดไฟ
...
แนวทางการแก้ปัญหาที่เหมาะสมมี 2 วิธี ได้แก่:

1. **การจัดการข้อมูลทางสถิติ:** ควร **ตัดข้อมูลแซมเปิ้ลที่ 1-9 ทิ้งไป** เนื่องจากระบบยังอยู่ในช่วงการเปลี่ยนแปลง (Transient State) และเลือกนำเฉพาะข้อมูลจาก **แซมเปิ้ลที่ 10-20** มาคำนวณหาค่าเฉลี่ยแบบตัดค่าสุดโต่ง (Trimmed Mean) เพราะในช่วงนี้สัญญาณได้เข้าสู่สภาวะคงตัว (Steady State) แล้ว
2. **การจัดการด้วยโปรแกรม (Software Handling):** สามารถออกแบบโปรแกรมโดยเพิ่มคำสั่งหน่วงเวลา (Delay) **อย่างน้อย 1,500 ms** หลังจากสั่งปิดไฟ ก่อนที่จะเริ่มทำการสุ่มอ่านค่าจริง เพื่อข้ามช่วง Transient ไปโดยสมบูรณ์ ซึ่งแนวทางนี้สอดคล้องกับทฤษฎี RC Settling Time (ตามทฤษฎีอาจใช้เวลา 2-3 วินาที แต่จากข้อมูลการทดลองจริงพบว่าระยะเวลา 1.2 - 1.5 วินาที สัญญาณก็เริ่มเข้าสู่สภาวะนิ่งเพียงพอต่อการนำไปใช้งานแล้ว)

### 🎥 วิดีโอผลการทดลอง
[คลิกเพื่อรับชมวิดีโอผลการทดลอง Lab 2](https://youtube.com/shorts/4PkjLg1GmQ0?si=YVqle5b82O-yFb1h)