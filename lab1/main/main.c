...
#define LED_R_GPIO        GPIO_NUM_23
#define LED_G_GPIO        GPIO_NUM_22
#define LED_B_GPIO        GPIO_NUM_21
...
void init_rgb_gpio(void)
{
    ...
    gpio_set_level(LED_R_GPIO, 1);  // ถ้า common anode ต้องแก้เป็น gpio_set_level(LED_R_GPIO, 1); 
    gpio_set_level(LED_G_GPIO, 1);  // ถ้า common anode ต้องแก้เป็น gpio_set_level(LED_G_GPIO, 1); 
    gpio_set_level(LED_B_GPIO, 1);  // ถ้า common anode ต้องแก้เป็น gpio_set_level(LED_B_GPIO, 1); 
}
