...
1. **การคัดกรองข้อมูลคุณภาพ (Data Selection Report)**
    ...
    **ภาพผลการทดลองใน Serial Monitor**

    ![Statistical Signal Processing Result](../Images/lab3_screenshot.png)

    **ตารางสรุปผลการคัดกรองข้อมูลคุณภาพ (5 รอบการทดลอง)**

    | รอบที่ | เฟสสี R (Mean ± SD mV) | เฟสสี G (Mean ± SD mV) | เฟสสี B (Mean ± SD mV) | สถานะเกณฑ์คุณภาพวิศวกรรม |
    | :---: | :---: | :---: | :---: | :---: |
    | 1 | 1391.00 ± 6.00 | 727.00 ± 17.00 | 642.00 ± 23.00 | Pass (ผ่านเกณฑ์ SD ต่ำกว่า 35 mV) |
    | 2 | 1390.00 ± 6.00 | 718.00 ± 9.00 | 677.00 ± 28.00 | Pass (ผ่านเกณฑ์ SD ต่ำกว่า 35 mV) |
    | 3 | 1385.00 ± 9.00 | 810.00 ± 18.00 | 675.00 ± 26.00 | Pass (ผ่านเกณฑ์ SD ต่ำกว่า 35 mV) |
    | 4 | 1389.00 ± 9.00 | 803.00 ± 19.00 | 448.00 ± 13.00 | Pass (ผ่านเกณฑ์ SD ต่ำกว่า 35 mV) |
    | 5 | 1398.00 ± 1.00 | 792.00 ± 11.00 | 432.00 ± 17.00 | Pass (ผ่านเกณฑ์ SD ต่ำกว่า 35 mV) |
...
2. **คำถามเชิงวิเคราะห์ (Engineering Evaluation)**
    ...
    **ตอบ** การเปลี่ยนสถาปัตยกรรมมาใช้ `Trimmed Mean` ร่วมกับการทำ Oversampling ช่วยขจัดนอยส์ฉับพลัน (Outliers) สัญญาณรบกวนไฟบ้าน (AC Noise) และช่วงสภาวะชั่วครู่ (Transient Phase) ออกไปได้อย่างมีประสิทธิภาพ ทำให้ค่าความผันผวน ($SD$) ลดลงอย่างชัดเจน จากเดิมที่มีค่าผันผวนสูงและเกิดการแกว่งแบบฟันปลา เหลือค่า $SD$ อยู่ในช่วงที่ต่ำและเสถียรมาก (เพียงประมาณ 1.00 ถึง 28.00 mV) ทำให้ข้อมูลมีความคงที่และน่าเชื่อถือสูง
    ...
    **ตอบ** ข้อมูลระดับบิตดิบ (Raw Scale 0-4095) เป็นค่าเฉพาะของตัวประมวลผลซึ่งขึ้นอยู่กับคุณลักษณะทางกายภาพของชิปแต่ละตัว เช่น Vref Drift, ความไม่เชิงเส้น (Non-linearity) และความคลาดเคลื่อนจากการผลิต ทำให้บอร์ดคนละตัวอาจอ่านค่าบิตดิบได้ไม่เท่ากันแม้รับแสงเท่ากัน การแปลงเป็น **แรงดันทางกายภาพ (mV)** โดยผ่านฮาร์ดแวร์ปรับเทียบ (eFuse Line Fitting Calibration) จึงเป็นสะพานเชื่อมระหว่าง "โลกกายภาพ" และ "โลกดิจิทัล" ที่สร้างหน่วยวัดมาตรฐานสากลที่เป็นกลาง ทำให้ขั้นตอนตัดสินใจของอัลกอริทึมควบคุมหุ่นยนต์มีความเสถียร แม่นยำ และสามารถนำซอฟต์แวร์ไปใช้อุปกรณ์อื่นได้โดยไม่ต้องสอบเทียบใหม่
