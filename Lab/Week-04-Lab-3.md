...
2. **คำถามเชิงวิเคราะห์ (Engineering Evaluation):**
    ...
    - หลังจากเปลี่ยนสถาปัตยกรรมซอฟต์แวร์มาใช้ระบบกรองบิตดิบแบบ `Trimmed Mean` ก่อนทำการแปลงแรงดัน เปรียบเทียบกับพฤติกรรมอนุกรมเวลาในใบงานที่ 2 แล้ว ค่าความผันผวน ($SD$) มีการพัฒนาไปในทางที่ดีขึ้นอย่างไร?
        ...
        ตอบ หลังจากเปลี่ยนสถาปัตยกรรมซอฟต์แวร์มาใช้ระบบกรองบิตดิบแบบ Trimmed Mean ก่อนการแปลงแรงดัน พบว่าค่า SD ของข้อมูลลดลงและมีความสม่ำเสมอมากขึ้นเมื่อเปรียบเทียบกับใบงานที่ 2 เนื่องจากระบบสามารถลดผลกระทบจากค่า ADC ที่ผิดปกติ (Outlier) และสัญญาณรบกวน ทำให้ค่าที่วัดได้มีความเสถียรและเหมาะสมสำหรับนำไปวิเคราะห์มากขึ้น
    ...
    ตอบ การใช้หน่วยวัดเป็นแรงดันทางกายภาพ (mV) มีความสำคัญมากกว่าการใช้ค่า Raw ADC 0–4095 เนื่องจากค่าแรงดันเป็นค่าที่สะท้อนคุณสมบัติจริงของสัญญาณจากเซนเซอร์ สามารถเปรียบเทียบและนำไปใช้งานกับอุปกรณ์อื่นได้ ในขณะที่ค่า Raw ADC เป็นเพียงค่าดิจิทัลภายในไมโครคอนโทรลเลอร์ ซึ่งขึ้นอยู่กับความละเอียด ADC และการตั้งค่าของระบบ การแปลงเป็น mV จึงช่วยเชื่อมโยงระหว่างโลกกายภาพ (Physical World) กับโลกดิจิทัล (Digital World) ทำให้ระบบควบคุมมีความแม่นยำและเสถียรมากขึ้น

    Link Video
    https://youtu.be/QSuOF47BK9Y?si=F6_WxsiQpRLIsVoz