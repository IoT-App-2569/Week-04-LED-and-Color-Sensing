...
1. **การพล็อตพฤติกรรมทางกายภาพ (Transient Response Curve)**
    ...
    **ผลลัพธ์กราฟจากการทดลอง**

    ![Transient Response Curve](../Images/lab2_transient_response.png)
...
2. **คำถามนำเพื่อการวิเคราะห์เชิงระบบ (Critical Thinking)**
    ...
    **ตอบ** จากกราฟจะสังเกตเห็นได้อย่างชัดเจนว่าค่า ADC จะเริ่มต้นด้วยค่าที่สูงมากในแซมเปิ้ลแรก จากนั้นตัวเลขจะค่อยๆ ลดระดับลงมาตามลำดับอย่างต่อเนื่อง จนกระทั่งมีค่าเข้าใกล้ศูนย์ในแซมเปิ้ลท้ายๆ ซึ่งแสดงถึงพฤติกรรมการคายประจุ

    - สัญญาณไฟฟ้าเข้าสู่ความนิ่ง (Settling) ที่แซมเปิ้ลใด หรือใช้เวลากี่มิลลิวินาที?
    **ตอบ** สัญญาณเริ่มเข้าสู่ระดับนิ่งและเสถียรที่ค่าศูนย์ประมาณแซมเปิ้ลที่ 16 ซึ่งใช้เวลาประมาณสองพันสี่ร้อยมิลลิวินาทีหลังจากที่เปลี่ยนแสงกระตุ้น
    ...
    **ตอบ** ความลาดชันของการคายประจุที่ค่อยเป็นค่อยไปนี้ สะท้อนให้เห็นว่ารอยต่อ PN ของ LED มีคุณสมบัติของตัวเก็บประจุแฝงอยู่ และวงจรตัวเก็บประจุสุ่มและพักค่าภายในไมโครคอนโทรลเลอร์ต้องใช้เวลาในการคายประจุไฟฟ้าเดิมทิ้งให้หมดผ่านช่องทางที่มีความต้านทานสูงมาก ทำให้แรงดันไม่สามารถตกลงเป็นศูนย์ได้ในทันที
    ...
    **ตอบ** เราควรเลือกนำเฉพาะค่าจากแซมเปิ้ลในช่วงท้ายๆ ที่สัญญาณนิ่งแล้วมาใช้คำนวณเท่านั้น เช่น ช่วงแซมเปิ้ลที่ 16 ถึง 20 หรือหากจะเขียนโปรแกรมก็ควรสั่งให้ระบบรอเวลาทิ้งไปเลยประมาณสองพันห้าร้อยมิลลิวินาทีหลังจากการเปลี่ยนสีไฟ เพื่อให้มั่นใจว่าแรงดันนิ่งสนิทแล้วจึงค่อยสุ่มเก็บข้อมูลเพื่อนำไปหาค่าเฉลี่ยต่อไป
