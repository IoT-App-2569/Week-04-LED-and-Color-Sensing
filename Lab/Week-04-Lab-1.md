...
จากการสังเกตการทำงานของ LED RGB พบว่า ระบบสามารถควบคุมการเปิด–ปิด LED ตามลำดับเวลาที่กำหนด โดย LED จะแสดงผลทีละสี ได้แก่ สีแดง (R) → สีเขียว (G) → สีน้ำเงิน (B) และมีช่วงพัก (Rest Phase) หลังจบการแสดงผลแต่ละรอบ ช่วงพักช่วยให้ระบบกลับเข้าสู่สภาวะคงที่ก่อนเริ่มรอบใหม่ ซึ่งสอดคล้องกับแนวคิด Transient State และ Settling Time จากการทดลองพบว่า LED เปลี่ยนสีได้อย่างชัดเจน ไม่มีการติดพร้อมกันหลายสี และการทำงานเป็นไปตามเงื่อนไขที่กำหนดในโปรแกรม

Link Video
https://youtube.com/shorts/GlvBL30FCWw?si=Nw6WqHysgdkOrCcU